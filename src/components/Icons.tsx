...
export function IconProjects({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function IconBell({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M15 17H9l-1-4H6l2-9h8l2 9h-2l-1 4z" strokeLinejoin="round" />
...
export function IconUser({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M5 20c1.5-3 4-4 7-4s5.5 1 7 4" strokeLinecap="round" />
    </svg>
  );
}
